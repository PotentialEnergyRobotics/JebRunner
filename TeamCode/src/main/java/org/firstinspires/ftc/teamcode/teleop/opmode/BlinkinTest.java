...
public class BlinkinTest extends OpMode {
    ...
    int patternNum = 0;
    RevBlinkinLedDriver.BlinkinPattern[] patternSeq = { RevBlinkinLedDriver.BlinkinPattern.GREEN, RevBlinkinLedDriver.BlinkinPattern.RAINBOW_LAVA_PALETTE, RevBlinkinLedDriver.BlinkinPattern.WHITE };
    ...
    {
        if (patternNum == patternSeq.length) patternNum = 0;

        blinkinLedDriver.setPattern(patternSeq[patternNum++]);
